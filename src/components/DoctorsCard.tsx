...
const DoctorsCard = ({ doctor }) => {
  ...
  return (
    <Link href={`/doctors/${id}`} passHref>
      <div className="p-3 lg:p-5 hover:bg-zinc-100 transition cursor-pointer hover:shadow-panelShadow hover:shadow-blue-200/70">
        <div>
          <Image src={photo} alt="image" className="w-full" />
        </div>
        ...
        <div className="mt-2 lg:mt-4 flex items-center justify-between">
          ...
          <div className="centered-row gap-[6px]">
            <span className="flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold text-headingColor">
              <Image src={starIcon} alt="star_icon" /> {avgRating}
            </span>
